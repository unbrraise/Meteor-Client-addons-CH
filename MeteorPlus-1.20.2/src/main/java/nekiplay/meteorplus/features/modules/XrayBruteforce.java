...
public class XrayBruteforce extends Module {
    public XrayBruteforce() {
        super(MeteorPlus.CATEGORY, "X射线暴力破解", "绕过反透视");
