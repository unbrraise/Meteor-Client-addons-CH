...
public class NewChunks extends Module {
    ...
    public NewChunks() {
        super(NumbyHack.CATEGORY,"新区块(会崩溃)", "使用的某些特征检测全新区块");
    }
